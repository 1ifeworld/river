...
export const AllChannelsDocument = gql`
  ...
  channels(orderBy: "timestamp", orderDirection: "desc") {
    items {
      ...
      adds(limit: 10, orderBy: "timestamp", orderDirection: "desc") {
        items {
          timestamp
        }
      }
