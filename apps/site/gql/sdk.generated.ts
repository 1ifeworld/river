...
export type MessageFilter = {
  ...
  parentPostId_not_in?: InputMaybe<
  ...
  addss?: {
    ...
    items?: Array<{
      ...
      channel: {
        ...
        adds?: {
          __typename?: 'AddsPage'
          items?: Array<{ __typename?: 'Adds'; itemId: string }> | null
        } | null
      }
    }> | null
  } | null
...
export type ChannelsItemsWithUserQuery = {
    ...
    items?: Array<{
      ...
      adds?: {
        ...
        items?: Array<{
          ...
          timestamp: any
          removed?: boolean | null
          item: { __typename?: 'Item'; uri: string }
        }> | null
      } | null
    }> | null
  } | null
  items?: {
    __typename?: 'ItemPage'
    items?: Array<{ __typename?: 'Item'; timestamp: any; uri: string }> | null
  } | null
}
...
export type ItemPageQuery = {
  ...
  adds?: {
    ...
    itemId: string
    channelId: string
    channel: { __typename?: 'Channel'; name: string }
    item: { __typename?: 'Item'; uri: string; createdById: any }
  } | null
}
...
export type MarqueeDataQuery = {
  __typename?: 'Query'
  userCounters?: {
    __typename?: 'UserCounterPage'
    items?: Array<{ __typename?: 'UserCounter'; counter: any }> | null
  } | null
  itemCounters?: {
    __typename?: 'ItemCounterPage'
    items?: Array<{ __typename?: 'ItemCounter'; counter: any }> | null
  } | null
  channelCounters?: {
    __typename?: 'ChannelCounterPage'
    items?: Array<{ __typename?: 'ChannelCounter'; counter: any }> | null
  } | null
}
...
export function getSdk(
  ...
  return {
    allAdds(
      variables?: AllAddsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<AllAddsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AllAddsQuery>(AllAddsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'allAdds',
    ...
    channelsItemsWithUser(
      ...
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<ChannelsItemsWithUserQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ChannelsItemsWithUserQuery>(
            ChannelsItemsWithUserDocument,
            variables,
    ...
    itemPage(
      ...
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<ItemPageQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ItemPageQuery>(ItemPageDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'itemPage',
    ...
    itemWithId(
      variables: ItemWithIdQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<ItemWithIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ItemWithIdQuery>(ItemWithIdDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'itemWithId',
    ...
    marqueeData(
      variables?: MarqueeDataQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<MarqueeDataQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<MarqueeDataQuery>(MarqueeDataDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'marqueeData',
